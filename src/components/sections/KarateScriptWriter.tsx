...
import { FileCode, Zap, Download, FileText, Send, Upload, X, Eye } from "lucide-react";
...
export function KarateScriptWriter({ jiraData, onConfigOpen }: KarateScriptWriterProps) {
  ...
  const handleAutoGenerateFromJira = async () => {
    ...
    try {
      ...
      setGeneratedScripts(result.response || result.scripts || "No Karate scripts generated");
      ...
      toast({
        title: "Error",
        description: "Could not auto-generate Karate scripts from JIRA. Check SVC cluster connection.",
        variant: "destructive",
      });
    } finally {
  ...
  const handleGenerateScripts = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Could not generate Karate scripts. Check SVC cluster connection.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>Karate Script Writer</span>
            {jiraData && (
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">
            Generate Karate API test scripts from JIRA stories or uploaded files.
          </p>
